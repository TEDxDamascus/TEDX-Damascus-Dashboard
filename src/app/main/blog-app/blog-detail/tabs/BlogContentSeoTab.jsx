...
function ContentFontSelect({ value, onChange, options, label, disabled, error, helperText }) {
  return (
    <FormControl fullWidth size="small" error={error} disabled={disabled} sx={{ mb: 1.5 }}>
        ...
        <Grid item xs={12}>
          <Controller
            ...
            render={({ field: fontField }) => {
              const fontLocale = ensureLocaleValue(fontField.value);
              const fontOptions = blogFonts?.options ?? [];
              const defaultFont = blogFonts?.default || 'cairo';
                    ...
                    return (
                      <Box>
                        ...
                        <RichTextEditor
                          ...
                          fontFamily={blogFontValueToCssFamily(fontLocale.en || defaultFont)}
                        />
                        ...
                        <RichTextEditor
                          ...
                          fontFamily={blogFontValueToCssFamily(fontLocale.ar || defaultFont)}
                        />
                        {errors.content && (
